...
- **$\vec{C_{1}}, \vec{C_{2}}$**: Their respective light-speed velocity vectors (where speed is variable and not fixed at a constant $c$)
- **$\rightarrow$**: Denotes direction of motion

### Core Idea
* The greater the difference in the light-speed velocity vectors (both in magnitude and direction) of the two masses, the greater the generated energy.
* The smaller the difference, the smaller the generated energy.
* If both masses travel with identical light-speed magnitude and direction ($\vec{C_{1}} = \vec{C_{2}}$), the net generated energy drops to absolute zero.
...
**Author:** Prakash Chandra//Uttrakhand(INDIA)//e-mail:pcgango55@gmail.com
